...
public class AkazeImageFinder {
  ...
  //      logger.info("AkazeImageFinder - findImage() started...");
    //    setupOpenCVEnv();
        ...
        Mat img_object = Imgcodecs.imread(object_filename, Imgcodecs.CV_LOAD_IMAGE_UNCHANGED);
        Mat img_scene = Imgcodecs.imread(scene_filename, Imgcodecs.CV_LOAD_IMAGE_UNCHANGED);
...
//        logger.info("Initial size: " + initial_height + ", " + initial_width);
        ...
        Imgcodecs.imwrite(scene_filename, img_scene);
